from app.fakenews.utils import twittertime_to_timestamp
...
class PropagationGraph():
    ...
    def _build_heirarchy(self):
        ...
        self.metadata['num_tweets'] = 0
        self.metadata['num_retweets'] = 0
        self.metadata['num_quotes'] = 0
        self.metadata['num_replies'] = 0
        ...
        self.metadata['num_cascades'] = len(self.cascade_roots)
        self.metadata['propagation_time'] = last_node_ts - first_node_ts
